const uploadFiles = (() => {
	...
	const ENDPOINTS = {
		UPLOAD: 'http://192.168.1.169/upload/upload-file-main/upload',
		UPLOAD_STATUS: 'http://192.168.1.169/upload-status',
		UPLOAD_REQUEST: 'http://192.168.1.169/upload/upload-file-main/upload-request'
	}
	...
	const uploadFile = (file, options) => {
		return fretch(ENDPOINTS.UPLOAD_REQUEST, {
			method: 'POST',
			headers: {
